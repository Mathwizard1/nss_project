              ...
              FloatingActionButton(
                  ...
                  onPressed: () async {
                    await FirebaseFirestore.instance
                        ...
                        .update({
                      'sem-1-hours':
                          FieldValue.increment(int.parse(searchcontroller.text))
                    });
                    setState(() {
              ...
              FloatingActionButton(
                  ...
                  onPressed: () async {
                    await FirebaseFirestore.instance
                        ...
                        .doc(widget.person.id)
                        .update({
                      'sem-1-hours': FieldValue.increment(
                          ...
                          child: Padding(
                            ...
                            child: RichText(
                              ...
                              text: TextSpan(
                                  ...
                                  children: <TextSpan>[
                                    TextSpan(
                                        text: getCapitalizedName(
                                            widget.person['full-name'] + '\n'),
                                        style: const TextStyle(
                              ...
                              RichText(
                                  text: TextSpan(
                                    ...
                                    const TextSpan(
                                      ...
                                      style: TextStyle(
                                          color:
                                              Color.fromARGB(255, 59, 129, 2)),
                                    ),
                                    TextSpan(
                                      text:
                                          '${widget.person['sem-1-hours'] + sem1buffer}',
                                      style: TextStyle(
                                          color: (widget.person['sem-1-hours'] <
                                                  (snapshot.data![
                                                          'mandatory-hours']) /
                                                      2)
                                              ? Colors.red
                                    ...
                                    TextSpan(
                                        text:
                                            '${(snapshot.data!['mandatory-hours']) / 2}',
                                        style: const TextStyle(
                                            color: Colors.blue)),
                                  ])),
                                ...
                                builder: (context, value, child) {
                                  return Padding(
                                    ...
                                    child: LinearProgressIndicator(
                                        ...
                                        color: Colors.green,
                                        value: (widget.person['sem-1-hours'] /
                                                snapshot
                                                    .data!['mandatory-hours']) *
                                            value),
                                  );
                                },
                              ),
                            ...
                            children: [
                              RichText(
                                  text: TextSpan(
                                    ...
                                    TextSpan(
                                      text:
                                          '${widget.person['sem-2-hours'] + sem2buffer}',
                                      style: TextStyle(
                                          color: (widget.person['sem-2-hours'] <
                                                  (snapshot.data![
                                                          'mandatory-hours']) /
                                                      2)
                                              ? Colors.red
                                ...
                                builder: (context, value, child) {
                                  return Padding(
                                    ...
                                    child: LinearProgressIndicator(
                                        ...
                                        backgroundColor: Colors.blue,
                                        color: Colors.green,
                                        value: (widget.person['sem-2-hours'] /
                                                snapshot
                                                    .data!['mandatory-hours']) *
                                            value),
                                  );
                    ...
                    child: SizedBox(
                      ...
                      child: StreamBuilder(
                          ...
                          builder: (context, snaphot) {
                            ...
                            List<DropdownMenuEntry<String>> RoleEntries = roles
                  ...
                  SizedBox(
                    ...
                    child: Card.outlined(
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          setState(() async {
                            if (rolechange == 'volunteer' ||
                                rolechange == 'mentor') {
                              await FirebaseFirestore.instance
                                  .collection('users')
                                  .doc(widget.person.id)
                                  .update({"role": rolechange}).then(
                                      (value) => print(
