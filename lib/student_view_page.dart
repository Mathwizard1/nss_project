        ...
        children: <Widget>[
              ...
              Expanded(
                child: RichText(
                  text: TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text: '${(widget.person['first name']).substring(0,1).toUpperCase()}${widget.person['first name'].substring(1,)} ${(widget.person['last name']).substring(0,1).toUpperCase()}${widget.person['last name'].substring(1,)}\n',
                            style: const TextStyle(
          ...
          RichText(
              text: TextSpan(
                ...
                TextSpan(
                  text: '  20',style: const TextStyle(fontSize: 120.0,color: const Color.fromRGBO(200, 150, 82, 1)),
                ),
                TextSpan(text: '/',style: TextStyle(fontSize: 33.0)),
                TextSpan(text: '40',style: TextStyle(fontSize: 33.0,color: Colors.lightBlueAccent)),
              ])),SizedBox(height: height/8,),RichText(
              text: TextSpan(
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 20,
                ...
                TextSpan(
                  text: '  24',style: TextStyle(fontSize: 120.0,color: Colors.deepPurple[300]),
                ),
                TextSpan(text: '/',style: TextStyle(fontSize: 33.0)),
                TextSpan(text: '40',style: TextStyle(fontSize: 33.0,color: Colors.lightBlueAccent)),
              ]))
