...
class _PicEventListState extends State<PicEventList> {
  ...
  void initState() {
    ...
    super.initState();
    ConfigurablesStream = FirebaseFirestore.instance
    ...
    EventStream = FirebaseFirestore.instance
        ...
        .snapshots();
    MentorStream = FirebaseFirestore.instance
        .collection("users")
                      ...
                      for (var x in snapshot.data!.docs)
                        if ((selectedWing == 'All')
                          ...
                          if ((selectedMentor == 'All')
                              ? true
                              : x['organizing-mentor'].contains(selectedMentor))
                            x
                    ];
                    if (snapshot.hasData) {
                      return Padding(
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return _buildEvent(events[index], context);
                            }),
                      );
                    }
            ...
            return Opacity(
              ...
              child: Card.outlined(
                ...
                child: ListTile(
                  ...
                  subtitle: Text(
                      DateTimeFormatter.format(event['timestamp'].toDate())),
                  leading: Icon(
                      ...
                      Text(state,
                          style: TextStyle(
                              color: (state == "Active")
                                  ...
                                  : ((state == "Finished")
                                      ? const Color.fromARGB(255, 224, 57, 45)
