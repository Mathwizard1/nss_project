            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const PicProfilePage()));
              },
            ),
            IconButton(
                onPressed: () {
                    ...
                    child: ElevatedButton(
                      style: ButtonStyle(
                          backgroundColor: WidgetStateProperty.all(
                              const Color.fromARGB(255, 191, 193, 189)),
                      ...
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const PicEventList()));
                      },
                      child: Icon(
                        Icons.list_alt,
                        size: width / 3,
                ...
                children: [
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      style: ButtonStyle(
                          backgroundColor: WidgetStateProperty.all(
                              const Color.fromARGB(255, 155, 169, 215)),
                          shape: WidgetStateProperty.all(
                              const ContinuousRectangleBorder())),
                      onPressed: () {
                        Navigator.push(
                      ...
                      child: Icon(
                        Icons.person,
                        size: width / 3,
                        color: const Color.fromARGB(255, 80, 80, 200),
                      ),
                    ),
                  ),
                  const SizedBox(
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      style: ButtonStyle(
                          backgroundColor: WidgetStateProperty.all(
                              const Color.fromARGB(255, 19, 119, 45)),
                          shape: WidgetStateProperty.all(
                              const ContinuousRectangleBorder())),
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const WingPiechart()));
                      },
                      child: Icon(
                        Icons.pie_chart,
                        size: width / 3,
                        color: const Color.fromARGB(255, 100, 255, 165),
                      ),
                    ),
                  )
                ],
