...
class SecretaryWingChangepage extends StatefulWidget {
  ...
  @override
  State<SecretaryWingChangepage> createState() =>
      _SecretaryWingChangepageState();
}
...
class _SecretaryWingChangepageState extends State<SecretaryWingChangepage> {
  ...
  void getSnaps() async {
    wings = FirebaseFirestore.instance
        .collection('configurables')
        .doc('document')
        .get();
    secs = FirebaseFirestore.instance
        .collection('users')
              ...
              child: ListTile(
                ...
                onTap: () {
                  FirebaseFirestore.instance
                      .collection('users')
                      .doc(widget.id)
                      .update({"role": 'secretary', "wing": _newsecwing}).then(
                          (value) => debugPrint(
